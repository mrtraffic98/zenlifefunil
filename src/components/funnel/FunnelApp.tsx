...
import { DevNavSidebar } from "./DevNavSidebar";
...
export const FunnelApp = () => {
  ...
  // Preload imagens críticas do primeiro step
  useCriticalImagesPreload();
  ...
  if (step === 1) {
    return (
      <div className="min-h-screen bg-background flex flex-col">
        {import.meta.env.DEV && <DevNavSidebar currentStep={step} onStepChange={setStep} totalSteps={TOTAL_STEPS} />}
        {renderStep()}
      </div>
    );
  }
